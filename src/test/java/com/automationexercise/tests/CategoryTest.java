...
public class CategoryTest extends BaseTest {
    ...
    public void testViewCategoryProdcuts() {
        ...
        Assert.assertTrue(homePage.category().isCategorySidebarVisible(),
        ...
        CategoryPage categoryPage = homePage.category()
        ...
        Assert.assertTrue(categoryPage.getCategoryHeadingText().contains("WOMEN"),
                "Category heading should contain 'WOMEN'");

        // -- Step 7: Click 'Men' category to expand --
        categoryPage.category().clickCategory("Men");

        // -- Step 8: Click 'Tshirts' subcategory under Men --
        CategoryPage menCategoryPage = categoryPage.category()
        ...
        Assert.assertTrue(menCategoryPage.getCategoryHeadingText().contains("MEN"),
